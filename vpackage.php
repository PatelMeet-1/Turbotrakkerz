...
<body>
	...
	<section class="team py-5" id="team">
		<div class="container pb-xl-5 pb-lg-3">
			<h3 class="tittle text-center">Packages</h3>
			...
			<div class="row team-grid">
				...
				?>
					<div class="col-lg-3 col-sm-6 ">
						<div class="box13">
							<img src="<?php print $row['photo']; ?>" style="height:250px;width:250px" class="img-fluid img-thumbnail" alt="" />
							<div class="box-content">
								<h3 class="title"><?php print $row['title']; ?></h3>
								<span class="post"><?php print $row['price']; ?></span>

							</div>
						</div>
						<p><a href="vpackagedetails.php?p_id=<?php print $row['p_id']; ?>"> View Detail</a></p>
					</div>
