...
<body>
    ...
    <section class="contact py-5" id="contact">
        <div class="container py-md-5">
            <h3 class="tittle text-center"> REGISTER </h3>
                    ...
                    <form action="register_code.php" method="post">
                        <div class="main-w3layouts-sectns ">
                            <div class="w3-btm-spc form-text2 p-0">
                                ...
                                <input type="password" class="txt" name="password" id="password" placeholder="Enter Your password Here">
                                <input type="text" name="city" id="city" placeholder="Enter Your city Here">
                                <input type="text" name="contact" id="contact" placeholder="Enter Your contact Here"><br>
